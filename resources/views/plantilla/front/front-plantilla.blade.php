...
<body>
    ...
    @include('plantilla.front.front-header')


    <div class="container-fluid">
        <div class="row">
            <!-- Sidebar/Menú -->
            <nav id="sidebarMenu2" class="col-md-3 col-lg-2  bg-light sidebar collapse side">
                <div class="position-sticky pt-3">
                    @include('plantilla.front.front-sidebar')
                </div>
            </nav>
            ...
            <div class="row">
                ...
                <div class="col float-sm-start">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Directorio de
                                funcionarios</a></li>
                ...
                <div class="col float-sm-start">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Boletines
                                informativos</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted text-white">Contacto Limpio
                                Chiapas</a></li>
